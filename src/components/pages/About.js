      ...
      <div className="row no-gutters">
        ...
        <div className="col-md-8">
          <div className="card-body" id="text">
            ...
            <p className="card-text">My name is Edna Omadjambe. I am an entry level full stack web developer, attending The Ohio State University Full Stack Web Development bootcamp. 
              During my time in the bootcamp I have acquired professional skills in Javascript, HTML, CSS, Bootstrap, Node.js, Express.js, MYSQL, NoSQL, MongoDB, jQuery, PWA's, jest, ReactJs, GraphQL and MERN stack.
